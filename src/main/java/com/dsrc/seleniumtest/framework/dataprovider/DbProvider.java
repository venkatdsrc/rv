...
public class DbProvider extends AbstractDataProvider{
	...
	public static Object[][] getDataFromDb(String sql){
		...
		final String JDBC_DRIVER = null;//PreAndPost.config.getProperty("DB_Pkg");  
		final String DB_URL = null;//PreAndPost.config.getProperty("DB_Url");

		//  Database credentials
		final String USER = null;//PreAndPost.config.getProperty("DB_User");
		final String PASS = null;//PreAndPost.config.getProperty("DB_Pwd");
